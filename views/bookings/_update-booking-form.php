...
<div class="bookings-form">
    ...
    <?= $form->field($model, 'customer_name')->textInput(['value' => Yii::$app->user->identity->role_id <= 2 ? ''  : Yii::$app->user->identity->name]) ?>
    ...
    <?= $form->field($model, 'status')->hiddenInput(['value' => 'Booked'])->label(false) ?>
