...
<div class="bookings-bookings">
  ...
  <div class="row">
    <div class="d-flex align-items-between justify-content-between">
        ...
        <?= Html::beginForm(['bookings/index'], 'POST', ['class' => '  mw-100 navbar-search align-items-end']) ?>
        ...
        <?= Html::endForm() ?>
        <p>
            <?=  Html::a('Create Booking', ['bookings'], ['class' => 'btn btn-success']) ?>
        </p>
            ...
            <tbody>
              ...
              <?php foreach ($bookings as $key => $model): ?>
                  ...
                  <td><?= Html::encode($key+1) ?></td>
                      ...
                      <td><?= Html::encode(ucfirst(isset($model->user) && $model->user->name ? $model->user->name : $model->customer_name )) ?></td>
                      <td><?= Html::encode($model->user_type) ?></td>
                      <td>                    
                        <p class="card-text ">
                          <span class="<?php 
